...
- **`createPool()`**: creates the worker pool and returns helpers like `call`, `send`, and `shutdown`.
...
Now that we share the vocabulary, the snippets should feel a lot less spooky!
